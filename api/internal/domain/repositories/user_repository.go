...
func (ur *userRepository) Create(user *entities.UserDBModel) error {
	...
	query := `
		INSERT INTO users (first_name, last_name, email, password, is_active, password_reset_token)
		VALUES (:first_name, :last_name, :email, :password, :is_active, :password_reset_token)`
